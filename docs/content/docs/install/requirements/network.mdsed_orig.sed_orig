...
- A Network Proxy can be used to provide external connectivity to the Anchore Engine. See: [Network Proxy documentation]({{< ref "/docs/engine/engine_installation/configuration/network_proxies" >}}).