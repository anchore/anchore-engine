...
def list_events(source_servicename=None, source_hostid=None, event_type=None, resource_type=None, resource_id=None, level=None, since=None, before=None, page=None, limit=None):
    ...
    try:
        ...
        return_object = client.get_events(source_servicename=source_servicename, source_hostid=source_hostid, event_type=event_type,
