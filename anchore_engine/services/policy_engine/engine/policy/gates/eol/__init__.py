...
class SuidModeDiffTrigger(BaseImageTrigger):
...
class SuidFileAddTrigger(BaseImageTrigger):
...
class SuidFileDelTrigger(BaseImageTrigger):
...
class SuidDiffTrigger(BaseImageTrigger):
...
class SuidDiffGate(BaseImageGate):
    __lifecycle_state__ = LifecycleStates.eol
...
class BaseOutOfDateTrigger(BaseImageTrigger):
...
class ImageCheckGate(BaseImageGate):
...
class PkgDiffGate(BaseImageGate):
    __lifecycle_state__ = LifecycleStates.eol
...
class LowSeverityTrigger(BaseImageTrigger):
...
class MediumSeverityTrigger(BaseImageTrigger):
...
class HighSeverityTrigger(BaseImageTrigger):
...
class CriticalSeverityTrigger(BaseImageTrigger):
...
class UnknownSeverityTrigger(BaseImageTrigger):
...
class AnchoreSecGate(BaseImageGate):
...
class PkgNotPresentTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class PackageCheckGate(BaseImageGate):
...
class EffectiveUserTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class DirectiveCheckTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class ExposeTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class NoFromTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class PEntryMatchTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class GemNotLatestTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class GemNotOfficialTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class GemBadVersionTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class GemPkgFullMatchTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class GemPkgNameMatchTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class GemNoFeedTrigger(BaseImageTrigger):
    __lifecycle_state__ = LifecycleStates.eol
...
class LicenseBlacklistGate(BaseImageGate):
...
class PackageBlacklistGate(BaseImageGate):
    __lifecycle_state__ = LifecycleStates.eol
    __superceded_by__ = "packages"
