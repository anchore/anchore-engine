        ...
        for tfile in list(allfiles.keys()):
            ...
            if patt:
                ...
                try:
                    ...
                    member = anchore_engine.analyzers.utils._get_extractable_member(
                        tfl, basemember, memberhash=memberhash
                    )
                    ...
                    traceback.print_exc()
                    print(
                        "WARN: found package.json but cannot parse ("
                        + str(tfile)
                        + ") - exception: "
                        + str(err)
                    )
            ...
            if pkg_type == "npm":
                try:
                    ...
                    try:
                        ...
                        print(
                            "WARN: unable to add npm package ({}) from hints - excpetion: {}".format(
                                pkg_key, err
                            )
                        )
                except Exception as err:
