pkgs = [
    (
        ...
        '{"name": "py", "version": "1.9.0", "type": "python", "location": '
        ...
        '"/usr/lib/python3.8/site-packages/py/xml.pyi"], "license": "MIT license", '
        '"metadata": "Metadata-Version: 2.1\\nName: py\\nVersion: 1.9.0\\nSummary: '
        "library with cross-python path, ini-parsing, io, code, log "
        "facilities\\nHome-page: https://py.readthedocs.io/\\nAuthor: holger krekel, "
        "Ronny Pfannschmidt, Benjamin Peterson and others\\nAuthor-email: "
        ...
        ">=2.7, !=3.0.*, !=3.1.*, !=3.2.*, !=3.3.*\\n\\n.. image:: "
        "https://img.shields.io/pypi/v/py.svg\\n    :target: "
        "https://pypi.org/project/py\\n\\n.. image:: "
        "https://img.shields.io/conda/vn/conda-forge/py.svg\\n    :target: "
        "https://anaconda.org/conda-forge/py\\n\\n.. image:: "
        "https://img.shields.io/pypi/pyversions/pytest.svg\\n  :target: "
        "https://pypi.org/project/py\\n\\n.. image:: "
        "https://img.shields.io/travis/pytest-dev/py.svg\\n   :target: "
        "https://travis-ci.org/pytest-dev/py\\n\\n.. image:: "
        "https://ci.appveyor.com/api/projects/status/10keglan6uqwj5al/branch/master?svg=true\\n   "
        ":target: https://ci.appveyor.com/project/pytestbot/py\\n\\n\\n**NOTE**: "
        "this library is in **maintenance mode** and should not be used in new "
        "code.\\n\\nThe py lib is a Python development support library "
        "featuring\\nthe following tools and modules:\\n\\n* ``py.path``:  uniform "
        "local and svn path objects  -> please use pathlib/pathlib2 instead\\n* "
        "``py.apipkg``:  explicit API control and lazy-importing -> please use the "
        "standalone package instead\\n* ``py.iniconfig``:  easy parsing of .ini "
        "files -> please use the standalone package instead\\n* ``py.code``: dynamic "
        "code generation and introspection (deprecated, moved to ``pytest`` as a "
        "implementation detail).\\n\\n**NOTE**: prior to the 1.4 release this "
        "distribution used to\\ncontain py.test which is now its own package, see "
        "http://pytest.org\\n\\nFor questions and more information please visit "
        "http://py.readthedocs.org\\n\\nBugs and issues: "
        "https://github.com/pytest-dev/py\\n\\nAuthors: Holger Krekel and others, "
        '2004-2017\\n\\n\\n", "origin": "holger krekel, Ronny Pfannschmidt, Benjamin '
        'Peterson and others <pytest-dev@python.org>"}',
    ),
    (
        "/usr/lib/python3.8/site-packages/pytest",
        '{"name": "pytest", "version": "6.1.1", "type": "python", "location": '
        '"/usr/lib/python3.8/site-packages", "files": '
        ...
        '"/usr/lib/python3.8/site-packages/pytest/py.typed"], "license": "MIT", '
        '"metadata": "Metadata-Version: 2.1\\nName: pytest\\nVersion: '
        "6.1.1\\nSummary: pytest: simple powerful testing with Python\\nHome-page: "
        "https://docs.pytest.org/en/latest/\\nAuthor: Holger Krekel, Bruno Oliveira, "
        "Ronny Pfannschmidt, Floris Bruynooghe, Brianna Laugher, Florian Bruhin and "
        "others\\nLicense: MIT\\nProject-URL: Source, "
        ...
        "(>=1.8.2)\\nRequires-Dist: toml\\nRequires-Dist: pathlib2 (>=2.2.0) ; "
        'python_version < \\"3.6\\"\\nRequires-Dist: importlib-metadata (>=0.12) ; '
        'python_version < \\"3.8\\"\\nRequires-Dist: atomicwrites (>=1.0) ; '
        'sys_platform == \\"win32\\"\\nRequires-Dist: colorama ; sys_platform == '
        '\\"win32\\"\\nProvides-Extra: checkqa_mypy\\nRequires-Dist: mypy (==0.780) '
        "; extra == 'checkqa_mypy'\\nProvides-Extra: testing\\nRequires-Dist: "
        "argcomplete ; extra == 'testing'\\nRequires-Dist: hypothesis (>=3.56) ; "
        "extra == 'testing'\\nRequires-Dist: mock ; extra == "
        "'testing'\\nRequires-Dist: nose ; extra == 'testing'\\nRequires-Dist: "
        "requests ; extra == 'testing'\\nRequires-Dist: xmlschema ; extra == "
        "'testing'\\n\\n.. image:: "
        "https://docs.pytest.org/en/stable/_static/pytest1.png\\n   :target: "
        "https://docs.pytest.org/en/stable/\\n   :align: center\\n   :alt: "
        "pytest\\n\\n\\n------\\n\\n.. image:: "
        "https://img.shields.io/pypi/v/pytest.svg\\n    :target: "
        "https://pypi.org/project/pytest/\\n\\n.. image:: "
        "https://img.shields.io/conda/vn/conda-forge/pytest.svg\\n    :target: "
        "https://anaconda.org/conda-forge/pytest\\n\\n.. image:: "
        "https://img.shields.io/pypi/pyversions/pytest.svg\\n    :target: "
        "https://pypi.org/project/pytest/\\n\\n.. image:: "
        "https://codecov.io/gh/pytest-dev/pytest/branch/master/graph/badge.svg\\n    "
        ":target: https://codecov.io/gh/pytest-dev/pytest\\n    :alt: Code coverage "
        "Status\\n\\n.. image:: "
        "https://travis-ci.org/pytest-dev/pytest.svg?branch=master\\n    :target: "
        "https://travis-ci.org/pytest-dev/pytest\\n\\n.. image:: "
        "https://github.com/pytest-dev/pytest/workflows/main/badge.svg\\n    "
        ":target: "
        "https://github.com/pytest-dev/pytest/actions?query=workflow%3Amain\\n\\n.. "
        "image:: https://img.shields.io/badge/code%20style-black-000000.svg\\n    "
        ":target: https://github.com/psf/black\\n\\n.. image:: "
        "https://www.codetriage.com/pytest-dev/pytest/badges/users.svg\\n    "
        ":target: https://www.codetriage.com/pytest-dev/pytest\\n\\n.. image:: "
        "https://readthedocs.org/projects/pytest/badge/?version=latest\\n    "
        ":target: https://pytest.readthedocs.io/en/latest/?badge=latest\\n    :alt: "
        "Documentation Status\\n\\nThe ``pytest`` framework makes it easy to write "
        "small tests, yet\\nscales to support complex functional testing for "
        ...
        "===========================\\n\\n\\nDue to ``pytest``'s detailed assertion "
        "introspection, only plain ``assert`` statements are used. See "
        "`getting-started "
        "<https://docs.pytest.org/en/stable/getting-started.html#our-first-test-run>`_ "
        "for more examples.\\n\\n\\nFeatures\\n--------\\n\\n- Detailed info on "
        "failing `assert statements "
        "<https://docs.pytest.org/en/stable/assert.html>`_ (no need to remember "
        "``self.assert*`` names)\\n\\n- `Auto-discovery\\n  "
        "<https://docs.pytest.org/en/stable/goodpractices.html#python-test-discovery>`_\\n  "
        "of test modules and functions\\n\\n- `Modular fixtures "
        "<https://docs.pytest.org/en/stable/fixture.html>`_ for\\n  managing small "
        "or parametrized long-lived test resources\\n\\n- Can run `unittest "
        "<https://docs.pytest.org/en/stable/unittest.html>`_ (or trial),\\n  `nose "
        "<https://docs.pytest.org/en/stable/nose.html>`_ test suites out of the "
        "box\\n\\n- Python 3.5+ and PyPy3\\n\\n- Rich plugin architecture, with over "
        "850+ `external plugins <http://plugincompat.herokuapp.com>`_ and thriving "
        "community\\n\\n\\nDocumentation\\n-------------\\n\\nFor full "
        "documentation, including installation, tutorials and PDF documents, please "
        "see "
        "https://docs.pytest.org/en/stable/.\\n\\n\\nBugs/Requests\\n-------------\\n\\nPlease "
        "use the `GitHub issue tracker "
        "<https://github.com/pytest-dev/pytest/issues>`_ to submit bugs or request "
        "features.\\n\\n\\nChangelog\\n---------\\n\\nConsult the `Changelog "
        "<https://docs.pytest.org/en/stable/changelog.html>`__ page for fixes and "
        "enhancements of each version.\\n\\n\\nSupport "
        "pytest\\n--------------\\n\\n`Open Collective`_ is an online funding "
        "platform for open and transparent communities.\\nIt provides tools to raise "
        "money and share your finances in full transparency.\\n\\nIt is the platform "
        "of choice for individuals and companies that want to make one-time "
        "or\\nmonthly donations directly to the project.\\n\\nSee more details in "
        "the `pytest collective`_.\\n\\n.. _Open Collective: "
        "https://opencollective.com\\n.. _pytest collective: "
        "https://opencollective.com/pytest\\n\\n\\npytest for "
        "enterprise\\n---------------------\\n\\nAvailable as part of the Tidelift "
        "Subscription.\\n\\nThe maintainers of pytest and thousands of other "
        "packages are working with Tidelift to deliver commercial support "
        "and\\nmaintenance for the open source dependencies you use to build your "
        "applications.\\nSave time, reduce risk, and improve code health, while "
        "paying the maintainers of the exact dependencies you use.\\n\\n`Learn more. "
        "<https://tidelift.com/subscription/pkg/pypi-pytest?utm_source=pypi-pytest&utm_medium=referral&utm_campaign=enterprise&utm_term=repo>`_\\n\\nSecurity\\n^^^^^^^^\\n\\npytest "
        "has never been associated with a security vulnerability, but in any case, "
        "to report a\\nsecurity vulnerability please use the `Tidelift security "
        "contact <https://tidelift.com/security>`_.\\nTidelift will coordinate the "
        "fix and disclosure.\\n\\n\\nLicense\\n-------\\n\\nCopyright Holger Krekel "
        "and others, 2004-2020.\\n\\nDistributed under the terms of the `MIT`_ "
        "license, pytest is free and open source software.\\n\\n.. _`MIT`: "
        'https://github.com/pytest-dev/pytest/blob/master/LICENSE\\n\\n\\n", '
        '"origin": "Holger Krekel, Bruno Oliveira, Ronny Pfannschmidt, Floris '
    ...
    (
        ...
        "utility functions\\nfor smoothing over the differences between the Python "
        "versions with the goal of\\nwriting Python code that is compatible on both "
        "Python versions.  See the\\ndocumentation for more information on what is "
        "provided.\\n\\nSix supports Python 2.7 and 3.3+.  It is contained in only "
        "one Python\\nfile, so it can be easily copied into your project. (The "
        "copyright and license\\nnotice must be retained.)\\n\\nOnline documentation "
        "is at https://six.readthedocs.io/.\\n\\nBugs can be reported to "
        "https://github.com/benjaminp/six.  The code can also\\nbe found "
    ...
    (
        ...
        '{"name": "toml", "version": "0.10.1", "type": "python", "location": '
        '"/usr/lib/python3.8/site-packages", "files": '
        ...
        '"/usr/lib/python3.8/site-packages/toml/tz.py"], "license": "MIT", '
        '"metadata": "Metadata-Version: 2.0\\nName: toml\\nVersion: '
        "0.10.1\\nSummary: Python Library for Tom's Obvious, Minimal "
        ...
        "PyPy\\n\\n****\\nTOML\\n****\\n\\n.. image:: "
        "https://badge.fury.io/py/toml.svg\\n    :target: "
        "https://badge.fury.io/py/toml\\n\\n.. image:: "
        "https://travis-ci.org/uiri/toml.svg?branch=master\\n    :target: "
        "https://travis-ci.org/uiri/toml\\n\\n.. image:: "
        "https://img.shields.io/pypi/pyversions/toml.svg\\n    :target: "
        "https://pypi.org/project/toml/\\n\\n\\nA Python library for parsing and "
        "creating `TOML <https://en.wikipedia.org/wiki/TOML>`_.\\n\\nThe module "
        "passes `the TOML test suite "
        "<https://github.com/BurntSushi/toml-test>`_.\\n\\nSee also:\\n\\n* `The "
        "TOML Standard <https://github.com/toml-lang/toml>`_\\n* `The currently "
    ...
    (
        ...
        "``packaging`` has being fully typed by adding a `py.typed` file (`#226 "
        "<https://github.com/pypa/packaging/issues/226>`__)\\n\\n19.2 - "
        ...
        "fallbacks for CPython ABI tag (`#181 "
        ...
        "debug wheels for Python 3.8 (`#172 "
        ...
        "handle two-digit versions in ``python_version`` (`#119 "
        "<https://github.com/pypa/packaging/issues/119>`__)\\n\\n\\n19.0 - "
        "2019-01-20\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix string representation of PEP 508 "
        "direct URL requirements with markers.\\n\\n* Better handling of file "
        "URLs\\n\\n  This allows for using ``file:///absolute/path``, which was "
        "previously\\n  prevented due to the missing ``netloc``.\\n\\n  This allows "
        "for all file URLs that ``urlunparse`` turns back into the\\n  original URL "
        "to be valid.\\n\\n\\n18.0 - 2018-09-26\\n~~~~~~~~~~~~~~~~~\\n\\n* Improve "
        "error messages when invalid requirements are given. (`#129 "
        "<https://github.com/pypa/packaging/issues/129>`__)\\n\\n\\n17.1 - "
        "2017-02-28\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix ``utils.canonicalize_version`` "
        "when supplying non PEP 440 versions.\\n\\n\\n17.0 - "
        "2017-02-28\\n~~~~~~~~~~~~~~~~~\\n\\n* Drop support for python 2.6, 3.2, and "
        ...
        "and ``LegacyVersion`` (`#34 "
        "<https://github.com/pypa/packaging/issues/34>`__).\\n\\n* Add "
        "``Version().is_devrelease`` and ``LegacyVersion().is_devrelease`` to\\n  "
        "make it easy to determine if a release is a development release.\\n\\n* Add "
        "``utils.canonicalize_version`` to canonicalize version strings or\\n  "
        "``Version`` instances (`#121 "
        "<https://github.com/pypa/packaging/issues/121>`__).\\n\\n\\n16.8 - "
        "2016-10-29\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix markers that utilize ``in`` so "
        "that they render correctly.\\n\\n* Fix an erroneous test on Python RC "
        "releases.\\n\\n\\n16.7 - 2016-04-23\\n~~~~~~~~~~~~~~~~~\\n\\n* Add support "
        "for the deprecated ``python_implementation`` marker which was\\n  an "
        "undocumented setuptools marker in addition to the newer "
        "markers.\\n\\n\\n16.6 - 2016-03-29\\n~~~~~~~~~~~~~~~~~\\n\\n* Add support "
        "for the deprecated, PEP 345 environment markers in addition to\\n  the "
        "newer markers.\\n\\n\\n16.5 - 2016-02-26\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix a "
        "regression in parsing requirements with whitespaces between the comma\\n  "
        "separators.\\n\\n\\n16.4 - 2016-02-22\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix a "
        "regression in parsing requirements like ``foo (==4)``.\\n\\n\\n16.3 - "
        "2016-02-21\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix a bug where "
        "``packaging.requirements:Requirement`` was overly strict when\\n  matching "
        "legacy requirements.\\n\\n\\n16.2 - 2016-02-09\\n~~~~~~~~~~~~~~~~~\\n\\n* "
        "Add a function that implements the name canonicalization from PEP "
        "503.\\n\\n\\n16.1 - 2016-02-07\\n~~~~~~~~~~~~~~~~~\\n\\n* Implement "
        "requirement specifiers from PEP 508.\\n\\n\\n16.0 - "
        "2016-01-19\\n~~~~~~~~~~~~~~~~~\\n\\n* Relicense so that packaging is "
        "available under *either* the Apache License,\\n  Version 2.0 or a 2 Clause "
        "BSD license.\\n\\n* Support installation of packaging when only distutils "
        "is available.\\n\\n* Fix ``==`` comparison when there is a prefix and a "
        "local version in play.\\n  (`#41 "
        "<https://github.com/pypa/packaging/issues/41>`__).\\n\\n* Implement "
        "environment markers from PEP 508.\\n\\n\\n15.3 - "
        "2015-08-01\\n~~~~~~~~~~~~~~~~~\\n\\n* Normalize post-release spellings for "
        "rev/r prefixes. `#35 "
        "<https://github.com/pypa/packaging/issues/35>`__\\n\\n\\n15.2 - "
        "2015-05-13\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix an error where the arbitary "
        "specifier (``===``) was not correctly\\n  allowing pre-releases when it was "
        "being used.\\n\\n* Expose the specifier and version parts through "
        "properties on the\\n  ``Specifier`` classes.\\n\\n* Allow iterating over "
        "the ``SpecifierSet`` to get access to all of the\\n  ``Specifier`` "
        "instances.\\n\\n* Allow testing if a version is contained within a "
        "specifier via the ``in``\\n  operator.\\n\\n\\n15.1 - "
        "2015-04-13\\n~~~~~~~~~~~~~~~~~\\n\\n* Fix a logic error that was causing "
        "inconsistent answers about whether or not\\n  a pre-release was contained "
        "within a ``SpecifierSet`` or not.\\n\\n\\n15.0 - "
        "2015-01-02\\n~~~~~~~~~~~~~~~~~\\n\\n* Add ``Version().is_postrelease`` and "
        "``LegacyVersion().is_postrelease`` to\\n  make it easy to determine if a "
        "release is a post release.\\n\\n* Add ``Version().base_version`` and "
        "``LegacyVersion().base_version`` to make\\n  it easy to get the public "
        "version without any pre or post release markers.\\n\\n* Support the update "
        "to PEP 440 which removed the implied ``!=V.*`` when using\\n  either ``>V`` "
        "or ``<V`` and which instead special cased the handling of\\n  pre-releases, "
        "post-releases, and local versions when using ``>V`` or ``<V``.\\n\\n\\n14.5 "
        "- 2014-12-17\\n~~~~~~~~~~~~~~~~~\\n\\n* Normalize release candidates as "
        "``rc`` instead of ``c``.\\n\\n* Expose the ``VERSION_PATTERN`` constant, a "
        "regular expression matching\\n  a valid version.\\n\\n\\n14.4 - "
        "2014-12-15\\n~~~~~~~~~~~~~~~~~\\n\\n* Ensure that versions are normalized "
        "before comparison when used in a\\n  specifier with a less than (``<``) or "
        "greater than (``>``) operator.\\n\\n\\n14.3 - "
        "2014-11-19\\n~~~~~~~~~~~~~~~~~\\n\\n* **BACKWARDS INCOMPATIBLE** Refactor "
        "specifier support so that it can sanely\\n  handle legacy specifiers as "
        "well as PEP 440 specifiers.\\n\\n* **BACKWARDS INCOMPATIBLE** Move the "
        "specifier support out of\\n  ``packaging.version`` into "
        "``packaging.specifiers``.\\n\\n\\n14.2 - "
        "2014-09-10\\n~~~~~~~~~~~~~~~~~\\n\\n* Add prerelease support to "
        "``Specifier``.\\n* Remove the ability to do ``item in Specifier()`` and "
        "replace it with\\n  ``Specifier().contains(item)`` in order to allow flags "
        "that signal if a\\n  prerelease should be accepted or not.\\n* Add a method "
        "``Specifier().filter()`` which will take an iterable and returns\\n  an "
        "iterable with items that do not match the specifier filtered "
        "out.\\n\\n\\n14.1 - 2014-09-08\\n~~~~~~~~~~~~~~~~~\\n\\n* Allow "
        "``LegacyVersion`` and ``Version`` to be sorted together.\\n* Add "
        "``packaging.version.parse()`` to enable easily parsing a version string\\n  "
        "as either a ``Version`` or a ``LegacyVersion`` depending on it's PEP "
        "440\\n  validity.\\n\\n\\n14.0 - 2014-09-05\\n~~~~~~~~~~~~~~~~~\\n\\n* "
        "Initial release.\\n\\n\\n.. _`master`: "
        'https://github.com/pypa/packaging/\\n\\n\\n", "origin": "Donald Stufft and '
        'individual contributors <donald@stufft.io>"}',
    ),
    (
        "/usr/lib/python3.8/site-packages/pip",
        '{"name": "pip", "version": "20.1.1", "type": "python", "location": '
        '"/usr/lib/python3.8/site-packages", "files": '
        ...
        '"license": "MIT", "metadata": "Metadata-Version: 2.1\\nName: pip\\nVersion: '
        "20.1.1\\nSummary: The PyPA recommended tool for installing Python "
        "packages.\\nHome-page: https://pip.pypa.io/\\nAuthor: The pip "
        "developers\\nAuthor-email: pypa-dev@groups.google.com\\nLicense: "
        "MIT\\nProject-URL: Documentation, https://pip.pypa.io\\nProject-URL: "
        "Source, https://github.com/pypa/pip\\nKeywords: distutils easy_install egg "
        "setuptools wheel virtualenv\\nPlatform: UNKNOWN\\nClassifier: Development "
        "Status :: 5 - Production/Stable\\nClassifier: Intended Audience :: "
        "Developers\\nClassifier: License :: OSI Approved :: MIT "
        "License\\nClassifier: Topic :: Software Development :: Build "
        "Tools\\nClassifier: Programming Language :: Python\\nClassifier: "
        ...
        "https://pip.pypa.io/en/latest\\n\\npip is the `package installer`_ for "
        "Python. You can use pip to install packages from the `Python Package "
        "Index`_ and other indexes.\\n\\nPlease take a look at our documentation for "
        "how to install and use pip:\\n\\n* `Installation`_\\n* `Usage`_\\n\\nWe "
        "release updates regularly, with a new version every 3 months. Find more "
        "details in our documentation:\\n\\n* `Release notes`_\\n* `Release "
        "process`_\\n\\nIn 2020, we're working on improvements to the heart of pip. "
        "Please `learn more and take our survey`_ to help us do it right.\\n\\nIf "
        "you find bugs, need help, or want to talk to the developers, please use our "
        "mailing lists or chat rooms:\\n\\n* `Issue tracking`_\\n* `Discourse "
        "channel`_\\n* `User IRC`_\\n\\nIf you want to get involved head over to "
        "GitHub to get the source code, look at our development documentation and "
        "feel free to jump on the developer mailing lists and chat rooms:\\n\\n* "
        "`GitHub page`_\\n* `Development documentation`_\\n* `Development mailing "
        "list`_\\n* `Development IRC`_\\n\\nCode of "
        "Conduct\\n---------------\\n\\nEveryone interacting in the pip project's "
        "codebases, issue trackers, chat\\nrooms, and mailing lists is expected to "
        "follow the `PyPA Code of Conduct`_.\\n\\n.. _package installer: "
        ...
        "page: https://github.com/pypa/pip\\n.. _Development documentation: "
        "https://pip.pypa.io/en/latest/development\\n.. _learn more and take our "
        "survey: "
        "https://pyfound.blogspot.com/2020/03/new-pip-resolver-to-roll-out-this-year.html\\n.. "
        "_Issue tracking: https://github.com/pypa/pip/issues\\n.. _Discourse "
        "channel: https://discuss.python.org/c/packaging\\n.. _Development mailing "
        "list: https://groups.google.com/forum/#!forum/pypa-dev\\n.. _User IRC: "
        "https://webchat.freenode.net/?channels=%23pypa\\n.. _Development IRC: "
        "https://webchat.freenode.net/?channels=%23pypa-dev\\n.. _PyPA Code of "
    ...
    (
        "/usr/lib/python3.8/site-packages/attrs",
        '{"name": "attrs", "version": "20.2.0", "type": "python", "location": '
        '"/usr/lib/python3.8/site-packages", "files": '
