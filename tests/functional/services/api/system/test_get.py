...
class TestSystemAPIGetReturns200:
    ...
    def test_get_system_services_endpoints(self, api_conf):
        ...
        if api_conf_name != 'get_api_conf':
            pytest.skip('System Services Endpoint only works for root user of admin account: currentUserAPIConf={}'
        ...
        for service in services:
            ...
            resp = http_get(['system', 'services', service_name, service_details[0].get('hostid')], config=api_conf)
            assert resp == APIResponse(200)
