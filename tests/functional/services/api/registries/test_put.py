...
class TestRegistriesAPIPutReturns200:
    ...
    def test_update_registry_by_name(self, add_and_teardown_registry):
        ...
        get_resp = http_get(['registries', quote(get_registry_info()['service_name'], '')], config=api_conf)
        ...
        update_resp = http_put(['registries', 'docker-registry:5000'], payload=update_payload, config=api_conf)
