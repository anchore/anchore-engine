...
def test_queue_rebalancer_empty():
    ...
    computed_queue_id_updates = _perform_queue_rebalance(queue_rebalance_input, highest_neg_queueId_input)
    ...
    if computed_test != expected_test:
        print ("INPUTS: highest_neg_queueId={} queue_rebalance={}".format(highest_neg_queueId_input, queue_rebalance_input))
...
def test_queue_rebalancer_spikeload_initial():
    ...
    queue_rebalance_input = queue_rebalance_template
    for i in range(0, 10):
        queue_rebalance_input["fooacct{}".format(i)]['lowest_queueId'] = random.randint(1, 10000000000)
    highest_neg_queueId_input = highest_neg_queueId_base
    computed_queue_id_updates = _perform_queue_rebalance(queue_rebalance_input, highest_neg_queueId_input)
...
def test_queue_rebalancer_spikeload_midway():
    ...
    for i in range(0, 5):
        ...
        queue_rebalance_input["fooacct{}".format(i)]['lowest_queueId'] = highest_neg_queueId_input
